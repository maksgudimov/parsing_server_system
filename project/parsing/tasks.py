...
def parsing_magnit():
    ...
    images_elements = driver.find_elements(By.CSS_SELECTOR,
    ...
    try:
        ...
        for prices_element in prices_elements:
            normal_price = prices_element.text.replace(",", ".").split(" ")[0]
            prices_list.append(normal_price)
        for last_prices_element in last_prices_elements:
            normal_last_price = last_prices_element.text.replace(",", ".").split(" ")[0]
...
def parsing_crossroads():
    ...
    driver.implicitly_wait(5)
    discounts_elements = driver.find_elements(By.CSS_SELECTOR, parsing.parsing_args['discounts_elements'])
